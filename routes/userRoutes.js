...
const { signup, login, getCurrentUser, logout, refreshToken } = require('../controllers/userController');
...
// POST /api/users/logout - Logout and revoke refresh tokens (requires authentication)
